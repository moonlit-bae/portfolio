# Full Stack Developer Portfolio — Zaid Qureshi

## About This Project

Welcome to my personal portfolio repository! This site serves as a comprehensive showcase of my skills, experience, and projects as a Full Stack Developer based in Saudi Arabia.
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/moonlit-bae/portfolio.git
    cd portfolio
    ```
...
The live version of this portfolio is hosted on **GitHub Pages** at: [https://moonlit-bae.github.io/portfolio/](https://moonlit-bae.github.io/portfolio/).
